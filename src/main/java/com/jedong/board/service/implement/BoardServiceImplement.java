...
import com.jedong.board.dto.request.board.PatchBoardRequestDto;
import com.jedong.board.dto.request.board.PostBoardRequestDto;
import com.jedong.board.dto.request.board.PostCommentRequestDto;
import com.jedong.board.dto.response.ResponseDto;
import com.jedong.board.dto.response.board.BoardListResponseDto;
import com.jedong.board.dto.response.board.CommentListResponseDto;
import com.jedong.board.dto.response.board.DeleteBoardResponseDto;
import com.jedong.board.dto.response.board.FavoriteListResponseDto;
import com.jedong.board.dto.response.board.GetBoardResponseDto;
import com.jedong.board.dto.response.board.GetCommentListResponseDto;
import com.jedong.board.dto.response.board.GetCurrentBoardResponseDto;
import com.jedong.board.dto.response.board.GetFavoriteListResponseDto;
import com.jedong.board.dto.response.board.GetSearchBoardResponseDto;
import com.jedong.board.dto.response.board.GetTop3ResponseDto;
import com.jedong.board.dto.response.board.GetUserListResponseDto;
import com.jedong.board.dto.response.board.PatchBoardResponseDto;
import com.jedong.board.dto.response.board.PostBoardResponseDto;
import com.jedong.board.dto.response.board.PostCommentResponseDto;
import com.jedong.board.dto.response.board.PutFavoriteResponseDto;
import com.jedong.board.entity.BoardEntity;
import com.jedong.board.entity.BoardViewEntity;
import com.jedong.board.entity.CommentEntity;
import com.jedong.board.entity.FavoriteEntity;
import com.jedong.board.entity.SearchLogEntity;
import com.jedong.board.entity.UserEntity;
import com.jedong.board.entity.resultSet.BoardListResultSet;
import com.jedong.board.entity.resultSet.CommentListResultSet;
import com.jedong.board.repository.BoardRepository;
import com.jedong.board.repository.BoardViewRepository;
import com.jedong.board.repository.CommentRepository;
import com.jedong.board.repository.FavoriteRepository;
import com.jedong.board.repository.SearchLogRepository;
import com.jedong.board.repository.UserRepository;
import com.jedong.board.service.BoardService;
